...
/** Expire every local Supabase Auth cookie named by the incoming request. */
export function expireSupabaseAuthCookies(request: Request, response: Response): Response {
