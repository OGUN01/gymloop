...
const styles = StyleSheet.create({
  ...
  hero: { alignSelf: 'stretch', height: UI_TOKENS.geometry.media.mobileAuthHeroHeight, borderRadius: UI_TOKENS.geometry.radii.sheet, borderCurve: 'continuous', resizeMode: 'cover' },
