...
select ok(exists(select 1 from pg_policies where schemaname='public' and tablename='member_imports' and policyname='member_imports_tenant_all') and exists(select 1 from pg_policies where schemaname='public' and tablename='member_imports' and policyname='member_imports_platform_all'),'the existing tenant and platform policies survive the migration');
