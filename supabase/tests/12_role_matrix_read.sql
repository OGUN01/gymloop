...
insert into public.notifications (id, tenant_id, member_id, channel, category, dedupe_key) values
  ('12000000-0000-4000-8000-00000000000f'::uuid, '12000000-0000-4000-8000-000000000001'::uuid, '12000000-0000-4000-8000-000000000031'::uuid, 'push', 'promotion', 'role-matrix-read-1'),
  ('12000000-0000-4000-8000-000000000010'::uuid, '12000000-0000-4000-8000-000000000001'::uuid, '12000000-0000-4000-8000-000000000032'::uuid, 'push', 'promotion', 'role-matrix-read-2');
