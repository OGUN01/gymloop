...
- **PAY-001** THE SYSTEM SHALL send renewal reminders at configurable day-offsets relative to membership expiry, defaulting to 14/7/3/0/+3 days (`RENEWAL_REMINDER_DAYS`).
